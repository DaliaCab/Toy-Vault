    ...
    return (
      <section className={styles.about_section}>
        <div className={styles.about_container}>
          ...
          <div className={`${styles.about_image} ${clickedImage === 1 ? styles.clicked : ''}`} onClick={() => handleClick(1)}>
          ...
          <div className={styles.about_text}>
            ...
            <h3>
              ¡Bienvenido a nuestro sitio web de figuras coleccionables! 
              Aquí encontrarás una variedad de artículos exclusivos y raros 
              para agregar a tu colección. Explora nuestra selección 
              y encuentra tu próximo tesoro.
            </h3>
          </div>
  
          {/* Segunda tarjeta con imagen y descripción */}
          <div className={`${styles.about_image} ${clickedImage === 2 ? styles.clicked : ''}`} onClick={() => handleClick(2)}>
            <img src={imagen2} alt="Descripción de la imagen 2" />
            <div className={styles.informacion}>
              <p>
                Colección exclusiva de figuras coleccionables. 
                Figuras de alta calidad inspiradas en personajes de anime 
                que agregarán valor a tu colección.
              </p>
            </div>
          </div>
        </div>
